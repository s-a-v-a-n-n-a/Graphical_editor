...
: Visual_object(par_base), tab(nullptr), canvas(nullptr)
{
	...
	Visual_object::Config tab_base = { this, (size_t)Vidget_type::TAB, get_position() + Vector_ll(predecessors_amount * DEFAULT_TAB_WIDTH, 0.0), tab_texture, TRANSPARENT, (size_t)280, INCREASED_BUTTON_HEIGHT };
