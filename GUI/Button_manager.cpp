...
Button *Button_manager::add_button_x(Button_delegate *par_delegate, const char *par_text, Texture *par_texture, const Color par_color, const size_t par_width, const size_t par_height)
{
...
Button *Button_manager::add_button_y(Button_delegate *par_delegate, const char *par_text, Texture *par_texture, const Color par_color, const size_t par_width, const size_t par_height)
{
...
Button *Button_manager::add_button(Button_delegate *par_delegate, const char *par_text, Texture *par_texture, const Color par_color, const size_t par_width, const size_t par_height)
{
	if (x)
		return add_button_x(par_delegate, par_text, par_texture, par_color, par_width, par_height);
	else
		return add_button_y(par_delegate, par_text, par_texture, par_color, par_width, par_height);
}
